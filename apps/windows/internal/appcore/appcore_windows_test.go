...
func TestClientEndToEnd(t *testing.T) {
	...
	sr, err := app.SignPDF(in, out, "M4 e2e", "Test User", "1357", appcore.QRPlacement{Page: 1, X: 0.6, Y: 0.8, W: 0.25})
	must(t, err)
	...
	if _, err := app.SignPDF(in, out, "x", "x", "9999", appcore.QRPlacement{}); err == nil {
